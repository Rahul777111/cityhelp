...
export default function Assistant() {
  ...
  const [messages, setMessages] = useState<Msg[]>([
    {
      role: "bot",
      text: "Hi, I am Civi, your CityHelp guide. Ask me anything, or pick a question below to get started.",
    },
  ]);
  ...
  const submitFree = () => {
    ...
    if (best) {
      ...
      setMessages((m) => [
        ...
        {
          role: "bot",
          text: "I am not sure about that one yet. Try rephrasing, or pick one of the suggested questions. I can help with reporting issues, tracking, departments, the map, analytics, accounts, themes, and more.",
        },
      ]);
      setQuery("");
    }
          ...
          >
            ...
            <div className="flex items-center gap-2 border-b border-[var(--border)] bg-[var(--brand)] px-4 py-3 text-white">
              ...
              <div className="leading-tight">
                <p className="text-sm font-semibold">Civi</p>
                <p className="text-[11px] text-white/80">Your CityHelp guide</p>
              </div>
            </div>
